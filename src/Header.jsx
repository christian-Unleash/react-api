...
export default function Header() {
  return (
    <div>
        ...
        <span className='font-bold text-xl'>CHU</span>
        </a>

        <div className='flex gap-2 border border-gray-500 rounded-full py-2 px-3 shadow-md shadow-gray-300'>
          <div>Any where</div>
        ...
        <Link to={'/login'} className="flex gap-2 border border-gray-500 rounded-full py-2 px-3">
